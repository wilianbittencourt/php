        ...
        <?php
          ...
          if(isset($_POST['enviar'])){
            if($fornecedor->inserirFornecedor($_POST) == "ok"){
              header('Location: fornecedor.php'); // Redireciona para uma nova URL após o envio do formulário
        ...
        ?>
            ...
            <form method="post" action="" autocomplete="off">
                <div class="form-group">
                    ...
                    <input type="text" name="fornecedor" class="form-control" placeholder="Nome do Cliente">
                </div>
                <div class="row">
                  <div class="col-md-3">
                    <div class="form-group">
